...
import { socialLinks, companyInfo } from '../data/links';
    ...
    <footer className="site-footer">
      <div className="footer-main">
        ...
        <div className="footer-col">
          ...
          <Link to="/services/cloud-devops-custom-integration">Cloud & DevOps</Link>
        ...
        <div className="footer-col">
          ...
          <Link to="/careers/open-positions">Careers</Link>
        ...
        <div className="footer-col">
          ...
          <Link to="/about/location">Locations</Link>
        </div>
      </div>
